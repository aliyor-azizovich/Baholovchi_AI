...
from PyQt5.QtWidgets import (
    ...
    QLabel, QTableWidgetItem, QStackedWidget, QVBoxLayout, QFileDialog, QMessageBox, 
)
...
class ValuationMainWindow(QMainWindow):
    ...
    def __init__(self, main_window, report_number):
        super().__init__()
        uic.loadUi(os.path.join(os.path.dirname(__file__), "valuation_main.ui"), self)
        ...
        self.tab_widget.addTab(self.general_info_tab, "Общие сведения")
        uic.loadUi(os.path.join(os.path.dirname(__file__), "general_info.ui"), self.general_info_tab)
