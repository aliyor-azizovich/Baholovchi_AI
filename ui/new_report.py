...
from PyQt5.QtWidgets import QDialog, QDialogButtonBox, QLineEdit, QDateEdit, QMessageBox
...
class NewReportWindow(QDialog):
    def __init__(self, main_window):
        super().__init__()
        ui_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "newReport.ui")
